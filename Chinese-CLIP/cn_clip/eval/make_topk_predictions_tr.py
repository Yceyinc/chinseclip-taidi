...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str, 
        # required=True,
        default="E:/LX_2024/TDB/Chinese-CLIP-master/TaiDiData/outputs/recall_top5/valid_imgs.img_feat.jsonl",
    ...
    parser.add_argument(
        ...
        type=str, 
        # required=True,
        default="E:/LX_2024/TDB/Chinese-CLIP-master/TaiDiData/outputs/recall_top5/valid_texts.txt_feat.jsonl",
    ...
    parser.add_argument(
        ...
        type=str, 
        # required=True,
        default="E:/LX_2024/TDB/Chinese-CLIP-master/TaiDiData/outputs/recall_top5/valid_predict_img2txt.jsonl",
