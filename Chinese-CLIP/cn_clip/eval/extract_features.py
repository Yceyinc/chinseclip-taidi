...
def parse_args():
    ...
    parser.add_argument(
        '--image-data', 
        type=str, 
        default="E:/LX_2024/TDB/Chinese-CLIP-master/TaiDiData/datasets/dataset_taidi/lmdb/valid/imgs",
        help="If --extract-image-feats is True, specify the path of the LMDB directory storing input image base64 strings."
    )
    parser.add_argument(
        '--text-data', 
        type=str, 
        default="E:/LX_2024/TDB/Chinese-CLIP-master/TaiDiData/datasets/dataset_taidi/valid_texts.jsonl",
        help="If --extract-text-feats is True, specify the path of input text Jsonl file."
    )
    parser.add_argument(
        '--image-feat-output-path', 
        type=str, 
        default=r"E:/LX_2024/TDB/Chinese-CLIP-master/TaiDiData/outputs/recall_top5/valid_imgs.img_feat.jsonl",
        help="If --extract-image-feats is True, specify the path of output image features."
    )    
    parser.add_argument(
        '--text-feat-output-path', 
        type=str, 
        default=r"E:/LX_2024/TDB/Chinese-CLIP-master/TaiDiData/outputs/recall_top5/valid_texts.txt_feat.jsonl",
    ...
    parser.add_argument(
        "--resume",
        default="E:/LX_2024/TDB/Chinese-CLIP-master/TaiDiData/experiments/TAIDI_finetune_vit-b-16_roberta-base_bs48_1gpu/checkpoints/epoch_latest.pt",
        type=str,
