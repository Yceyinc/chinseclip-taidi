...
if __name__=="__main__":
    # 填入验证集的文图数据 的 转 tr版 jsonl
    standard_path = "E:/LX_2024/TDB/Chinese-CLIP-master/TaiDiData/datasets/dataset_taidi/valid_texts.tr.jsonl"
    # 填入验证集预测文图数据jsonl： val_predictions.jsonl
    submit_path = "E:/LX_2024/TDB/Chinese-CLIP-master/TaiDiData/outputs/recall_top5/valid_predict_img2txt.jsonl"
    # 指定输出 验证结果的json文件路径  val_output.json
    out_path = "E:/LX_2024/TDB/Chinese-CLIP-master/TaiDiData/outputs/recall_top5/valid_img2txt_recallresult.json"
