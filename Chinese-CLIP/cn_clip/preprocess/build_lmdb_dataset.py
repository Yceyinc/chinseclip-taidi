...
def parse_args():
    ...
    parser.add_argument(
        "--data_dir", type=str, default=r"E:\LX_2024\TDB\Chinese-CLIP-master\TaiDiData\task3_datasets"
        ,help="the directory which stores the image tsvfiles and the text jsonl annotations"
    )
    parser.add_argument(
        "--splits", type=str, default="predict2",help="specify the dataset splits which this script processes, concatenated by comma \
